...
export const WorkspaceToolbar: React.FC<WorkspaceToolbarProps> = ({ 
  ...
  const applyFontSettingsToClone = (clonedDoc: Document) => {
    ...
    style.textContent = `
      ...
      .module-header .font-medium {
        font-size: ${fontSettings.moduleNameSize * 2}px !important;
        letter-spacing: 0.02em !important;
        word-spacing: 0.1em !important;
        white-space: nowrap !important;
        font-weight: 600 !important;
      }
      .module-header .text-gray-500 {
        font-size: ${fontSettings.moduleInfoSize * 2}px !important;
        letter-spacing: 0.01em !important;
        word-spacing: 0.05em !important;
      }
      .bg-gray-100.border.border-gray-300 {
        font-size: ${fontSettings.depthInfoSize * 2}px !important;
        letter-spacing: 0.01em !important;
      }
      
      /* ENHANCED MODULE NAME STYLING FOR HIGH-DPI EXPORT */
      .module-header .font-medium {
      ...
      /* FORCE CONSISTENT SPACING FOR ALL TEXT */
      .module-header span,
      .module-header div {
        letter-spacing: 0.02em !important;
        word-spacing: 0.1em !important;
      ...
      /* ENSURE HIGH QUALITY RENDERING FOR HIGH-DPI */
      * {
        -webkit-font-smoothing: antialiased !important;
        -moz-osx-font-smoothing: grayscale !important;
        text-rendering: optimizeLegibility !important;
      ...
      /* PRESERVE EXACT FONT SIZES AND SPACING */
      [style*="fontSize"] {
      ...
      /* SPECIFIC FIXES FOR MODULE HEADERS */
      .module-header {
      ...
      /* PREVENT BROWSER FONT SCALING INTERFERENCE */
      @media print {
        * {
